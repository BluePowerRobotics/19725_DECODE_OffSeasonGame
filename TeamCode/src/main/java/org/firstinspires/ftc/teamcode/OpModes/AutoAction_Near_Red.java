...
@Autonomous
@Config
public class AutoAction_Near_Red extends LinearOpMode {
    private Chassis chassis;
    private Turret turret;
    private Tracker tracker;
    private Sweeper sweeper;
    private static final int targetTagId = 24;
    ...
    public void runOpMode() {
        ...
        Pose2d[] eatPoses = HypParams.EatPosesRed;
        ...
        while (opModeIsActive()) {
            ...
            if (!actionRunner.isBusy()) {
                ...
                if (!isEmpty && isInNearShootingArea()) {
                    ...
                    actionRunner.add(new GoToShootingAreaAction_Near(chassis, sweeper, true));
    ...
    private boolean isInNearShootingArea() {
        return HypParams.BoundingBox.inAbsolute(RobotPosition.getInstance().getPose2d())
                .IsIntersected(HypParams.SHOOTING_AREA_NEAR_RED);
    }
