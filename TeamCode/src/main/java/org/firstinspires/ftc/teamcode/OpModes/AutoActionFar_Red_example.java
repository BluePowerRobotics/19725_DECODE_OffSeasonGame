...
@Autonomous(name = "AutoActionFar_Red_example", group = "Auto")
public class AutoActionFar_Red_example extends LinearOpMode {
    private enum Phase {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            if (isTimeToPark() && !parkingStarted) {
                ...
                sweeper.setStop();
                sweeper.update();
                actionRunner.add(new GoToStopPose(drive, HypParams.StopPoseFarRed, turret));
